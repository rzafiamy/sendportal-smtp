    ...
    public function messages()
    {
        switch ((int) $this->input('type_id')) {
            ...
            case EmailServiceType::SMTP:
                return [
                    'settings.domain.required' =>  __('The Smtp Email Service requires you to enter a domain'),
                    'settings.port.required' =>  __('The Smtp Email Service requires you to enter a port'),
                    'settings.username.required' =>  __('The Smtp Email Service requires you to enter an username'),
                    'settings.password.required' =>  __('The Smtp Email Service requires you to enter a password'),
                    'settings.encryption.required' =>  __('The Smtp Email Service requires you to enter an encryption'), 
					];
